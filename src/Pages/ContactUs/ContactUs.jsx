...
// Leaflet মার্কার আইকন ফিক্স (এটি ছাড়া ম্যাপে পিন দেখা যায় না)
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">123 City Hall Plaza, Metropolitan Area, Dhaka 1200</p>
                  </div>
                </div>
            ...
            <div className="card bg-base-100 shadow-xl p-8">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="form-control">
                  ...
                  <textarea className="textarea textarea-bordered h-24" placeholder="Describe your query..." required></textarea>
                </div>
                <button type="submit" className="btn btn-primary bg-blue-700 border-none w-full">Send Message</button>
              </form>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 mb-6 max-w-md mx-auto">
          <form onSubmit={handlesearch} className="relative">
            ...
            <button type="submit" className="absolute right-3 top-3 opacity-50">
              <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><circle cx="11" cy="11" r="8"></circle><path d="m21 21-4.3-4.3"></path></svg>
            </button>
          </form>
        </div>
          ...
          >
            ...
            {serviceCenter.map((center, i) => (
              <Marker key={i} position={[center.latitude, center.longitude]}>
                <Popup>
                  <div className="p-1">
                    <h3 className="font-bold text-blue-800 text-lg">{center.district}</h3>
                    <p className="text-sm"><strong>Coverage:</strong> {center.covered_area.join(", ")}</p>
                  </div>
                </Popup>
              </Marker>
            ))}
